...
<body background="bg.jpg">
    <div class="wrap">
        ...
        <div class="header">          
            <h1><font face="Arial Black">16Bit.Uinjkt</font></h1>
            <div class="tanggal">
                <?php
                    // Real Time Clock
                    echo date('d F Y');
        ...
        <div class="content"><center>
            ...
            <h2>Selamat Datang di 16bit.com</h2>
            <table>
                <tr><td>Nama</td><td>:</td><td>Muhammad Ananta Fajar</td></tr>
                <tr><td>NIM</td><td>:</td><td>11160910000043</td></tr>
                <tr><td>Program Studi</td><td>:</td><td>Teknik Informatika 2016</td></tr>
            </table>
            </form>
            ...
            <table>
				<p>Cek berat badan ideal anda</p>
				<tr><td>Tinggi Badan </td><td>:</td><td><input type="text" name="tb"></td><td>cm</td></tr>
                <tr><td>Berat Badan </td><td>:</td><td><input type="text" name="bb"></td><td>kg</td></tr>
            ...
            <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>?show=persegiPanjang">
				<p>Sistem Hitung Luas Persegi Panjang</p>
                <table>
                  <tr><td>Panjang </td><td>:</td><td><input type="text" name="panjang"></td></tr>
                  <tr><td>Lebar </td><td>:</td><td><input type="text" name="lebar"></td></tr>  
                </table>
            ...
            <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>?show=segitiga">
				<p>Sistem Hitung Luas Segitiga</p>
                <table>
                  <tr><td>Alas </td><td>:</td><td><input type="text" name="alas"></td></tr>
                  <tr><td>Tinggi </td><td>:</td><td><input type="text" name="tinggi"></td></tr>  
                </table>
                <input type="reset" name="reset" value="Reset"> <input type="submit" name="submit" value="Submit"> 
        ...
        <div class="footer">
            Copyright @2019 Muhammad Ananta Fajar 
        </div>
    </div>
</body>
</html>
